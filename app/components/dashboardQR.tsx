...
export default function QRForm() {
    ...
    const [qrCodeUrl, setQrCodeUrl] = useState(''); // Eksik state eklendi
    ...
    return (
        <div className="mt-10 space-y-6">
            <h1 className="text-5xl md:text-6xl font-extrabold text-white leading-tight">
                Gösterge paneli QR kod oluştur
            </h1>
            <p className="text-white text-lg md:text-xl">
                Gösterge panelinden ürettiğiniz QR kodlar sizin giriş kimliğinize bağlıdır tıklanma sayısını ve QR kodlarınızı kontrol edebilirsiniz.
            </p>
